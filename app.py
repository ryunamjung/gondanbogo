...
st.caption("공단파일은 해당sheet만 남기고 지워야함. ex)★ 25년 보고항목 (1,162) (의과) ")
st.caption("원내파일은 'EDI' / '한글명칭' / '수가코드' 컬럼 필요.")
...
with st.sidebar:
    ...
    st.markdown(
        "<div style='text-align:center; font-weight:700;'>프로그램 개발을 하는 심사간호사<br>RYORYO COMPANY</div>",
